...
namespace AvaliMod
{
    ...
    internal static class AvaliMaterialAllocator
    {
        ...
        private static readonly Dictionary<Material, AvaliMaterialAllocator.MaterialInfo> references = new Dictionary<Material, AvaliMaterialAllocator.MaterialInfo>();
